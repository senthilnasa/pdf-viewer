...
$navMap = [
    ...
    'reports'       => 'reports',
    'team'          => 'team',
    'viewer-style'  => 'branding',
    'audit-logs'    => 'audit',
    'settings'      => 'settings',
];
$currentKey = $navMap[$currentPage] ?? 'dashboard';

$_sidebarUser = $auth->currentUser();
$_isAdmin     = ($_sidebarUser['role'] ?? '') === 'admin';
...
$nav = [
    ...
    'categories' => ['Categories',     '../admin/categories.php',    'M3 7v10a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2h-6l-2-2H5a2 2 0 00-2 2z'],
    ...
    'branding'   => ['Branding',       '../admin/viewer-style.php',  'M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zm0 0h12a2 2 0 002-2v-4a2 2 0 00-2-2h-2.343M11 7.343l1.657-1.657a2 2 0 012.828 0l2.829 2.829a2 2 0 010 2.828l-8.486 8.485M7 17h.01'],
];
if ($_isAdmin) {
    $nav['audit'] = ['Audit Logs', '../admin/audit-logs.php', 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4'];
}
$nav['settings'] = ['Settings', '../admin/settings.php', 'M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z M15 12a3 3 0 11-6 0 3 3 0 016 0z'];
?>
<aside class="admin-sidebar" id="sidebar">
    <div class="sidebar-logo">
        <a href="../admin/">
            ...
            <span><?= e(getSetting('site_name', 'PDF Viewer')) ?></span>
        </a>
    </div>
    <nav class="sidebar-nav">
        <?php foreach ($nav as $key => [$label, $href, $icon]): ?>
        <a href="<?= $href ?>" class="nav-item <?= $currentKey === $key ? 'active' : '' ?>">
    ...
    <div class="sidebar-footer">
        <a href="../admin/profile.php" class="nav-item <?= $currentPage === 'profile' ? 'active' : '' ?>">
        ...
        <a href="../" target="_blank" class="nav-item">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" width="18" height="18"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"/></svg>
            <span>View Site</span>
        </a>
